var slideTemplateId = "CERTFICATE-SLIDE-ID-HERE"; // Sample: https://docs.google.com/spreadsheets/d/1cgK1UETpMF5HWaXfRE6c0iphWHhl7v-dQ81ikFtkIVk
var tempFolderId = "GDRIVE-FOLDER-ID-HERE"; // Create an empty folder in Google Drive
...
function createCertificates() {
  ...
  for (var i = 1; i < values.length; i++) {
    ...
    empSlide.replaceAllText(
      "Date",
      "Date: " +
        Utilities.formatDate(date, Session.getScriptTimeZone(), "MMMM dd, yyyy")
    );
